---
layout: bare
title: Bopomofo Reader - Support
---

# Bopomofo Reader - Support

## About Bopomofo Reader

Bopomofo Reader is a Chinese language learning tool that adds bopomofo (zhuyin) annotations to web pages. It features a built-in browser, reader mode, listening mode, vocabulary management, sentence collection, notes, and pronunciation practice with shadowing and scoring.
...
A: No. Bopomofo Reader works entirely offline and does not require any account registration.

**Q: Is my data stored on a server?**  
A: No. All your data (bookmarks, vocabulary, notes, settings) is stored locally on your device only. We do not operate any servers.

**Q: Does the app contain ads?**  
A: No. Bopomofo Reader is ad-free and does not include any advertising SDKs.

### Bopomofo & Reading

**Q: How do I toggle bopomofo display?**  
A: Tap the bopomofo button in the toolbar to turn bopomofo on or off. To switch between tonal and toneless bopomofo, go to Settings > Bopomofo Settings.
...
A: In reader mode, enable "Pronunciation" or "Definition" in the bottom toolbar, then tap any Chinese character to see its bopomofo and hear its pronunciation. When "Definition" is enabled, a dictionary panel shows detailed definitions from the built-in CC-CEDICT dictionary.
...
A: TTS voice quality depends on your device's system TTS engine. For better quality:
- **iOS**: Go to Settings > Accessibility > Spoken Content > Voices > Chinese, and download an enhanced voice.
- **Android**: Go to Settings > Accessibility > Text-to-speech output, install Google TTS or a preferred engine, and download the Chinese voice data.

**Q: The microphone is not working. What should I do?**  
A: Make sure you have granted both microphone and speech recognition permissions to the app. Go to your device's Settings > Bopomofo Reader, and ensure Microphone and Speech Recognition are enabled.

### Shadowing & Scoring

**Q: How does shadowing practice work?**  
A: In the listening player, tap the mic icon to start shadowing. Listen to the reference audio, then record your reading. The app scores your pronunciation, tone accuracy, fluency, and completeness. You can play back your recording to compare with the original.
...
A: Go to Settings > Clear Data to clear browsing history, bookmarks, and search history. Use Settings > Clear Archive to clear saved vocabulary, sentences, and notes. Alternatively, uninstalling the app removes all data.

**Q: Can I back up my data?**  
A: Currently, the app does not support cloud backup. All data is stored locally on your device.
...
Please refer to our [Privacy Policy](./privacy-policy) for information about how we handle your data.
