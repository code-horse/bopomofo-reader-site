...
- **Selection Speech** — Select any Chinese text, click the floating button or right-click "Speak Selection" to read aloud
...
Install **Bopomofo Reader** from the [Chrome Web Store](https://chromewebstore.google.com/), or load it locally in developer mode.
...
Select any Chinese text with mouse, click the 🔊 floating button to speak; or right-click and choose "Speak Selection".

> **Tip:** Click the extension icon in your browser toolbar to open the settings panel and adjust Bopomofo style, speech rate, and more.
...
Select Chinese text with your mouse, a green 🔊 button appears at the top right of the selection — click to speak.

**Method 2: Right-Click Menu**  
After selecting Chinese text, right-click and choose "Speak Selection" from the menu.

> **Tip:** Selection speech uses the sentence speech rate configured in your settings. Single character pronunciation uses the default rate.
